...
public class IfForgetAdapter extends RecyclerView.Adapter<IfForgetAdapter.PhotoViewHolder> {

    private List<Medicine> currentList;
    private Context mContext;
    private Map<Integer, Boolean> mFoldStates = new HashMap<>();

    public IfForgetAdapter(Context context, List<Medicine> dataset) {
        currentList = dataset;
        mContext = context;
    }
    ...
    public void onBindViewHolder(final PhotoViewHolder holder, int position) {
        ...
        holder.mTextViewCover.setText("If forget to take medicine");
    ...
    protected static class PhotoViewHolder extends RecyclerView.ViewHolder {
        ...
        public PhotoViewHolder(FoldableLayout foldableLayout) {
            ...
            foldableLayout.setupViews(R.layout.list_item_cover, R.layout.view_if_forget, R.dimen.card_cover_height, itemView.getContext());
