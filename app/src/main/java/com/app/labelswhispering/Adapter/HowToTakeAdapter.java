...
public class HowToTakeAdapter extends RecyclerView.Adapter<HowToTakeAdapter.PhotoViewHolder> {

    private List<Medicine> currentList;
    private Context mContext;
    private Map<Integer, Boolean> mFoldStates = new HashMap<>();

    public HowToTakeAdapter(Context context, List<Medicine> dataset) {
        currentList = dataset;
        mContext = context;
    }
    ...
    public void onBindViewHolder(final PhotoViewHolder holder, int position) {
        ...
        holder.mTextViewCover.setText("How to take medicine");
    ...
    protected static class PhotoViewHolder extends RecyclerView.ViewHolder {
        ...
        public PhotoViewHolder(FoldableLayout foldableLayout) {
            ...
            foldableLayout.setupViews(R.layout.list_item_cover, R.layout.view_how_to_take, R.dimen.card_cover_height, itemView.getContext());
