...
public class PhotoAdapter extends RecyclerView.Adapter<PhotoAdapter.PhotoViewHolder> {
    ...
    public PhotoAdapter(Context context, List<Medicine> dataset) {
        currentList = dataset;
        mContext = context;
    }
    ...
    public void onBindViewHolder(final PhotoViewHolder holder, int position) {
        ...
        holder.mTextViewCover.setText("Property");
    ...
    protected static class PhotoViewHolder extends RecyclerView.ViewHolder {
        ...
        public PhotoViewHolder(FoldableLayout foldableLayout) {
            ...
            foldableLayout.setupViews(R.layout.list_item_cover, R.layout.view_property, R.dimen.card_cover_height, itemView.getContext());
