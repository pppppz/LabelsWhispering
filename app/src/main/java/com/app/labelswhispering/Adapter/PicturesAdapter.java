...
public class PicturesAdapter extends RecyclerView.Adapter<PicturesAdapter.PhotoViewHolder> {

    private List<Medicine> currentList;
    private Context mContext;
    private Map<Integer, Boolean> mFoldStates = new HashMap<>();

    public PicturesAdapter(Context context, List<Medicine> dataset) {
        currentList = dataset;
        mContext = context;
    }
    ...
    public void onBindViewHolder(final PhotoViewHolder holder, int position) {
        ...
        holder.mTextViewCover.setText("Pictures");
    ...
    protected static class PhotoViewHolder extends RecyclerView.ViewHolder {
        ...
        public PhotoViewHolder(FoldableLayout foldableLayout) {
            ...
            foldableLayout.setupViews(R.layout.list_item_cover, R.layout.view_picture
