...
import com.app.labelswhispering.Adapter.UserMenuAdapter;
...
import com.app.labelswhispering.service.AlarmActivity;
...
public class SettingActivity extends AppCompatActivity {
    ...
    LinearLayout.OnClickListener profileListener = new LinearLayout.OnClickListener() {
        ...
        public void onClick(View v) {
            Intent intent = new Intent(SettingActivity.this, User_Edit_Activity.class);
            startActivity(intent);
        }
    };
