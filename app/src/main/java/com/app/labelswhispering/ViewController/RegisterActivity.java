...
public class RegisterActivity extends Activity {
    ...
    private EditText mUsernameField, mPasswordField, mNameField;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.app.labelswhispering.R.layout.register_view);
    ...
    public void register(final View v) {
        ...
        user.put("name", mNameField.getText());
