...
public class FacebookLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            PackageInfo info = getPackageManager().getPackageInfo("com.app.countdowntodolist", PackageManager.GET_SIGNATURES);
        ...
        ParseFacebookUtils.logInWithReadPermissionsInBackground(FacebookLogin.this, Arrays.asList("public_profile", "user_friends", "email", "user_birthday"), new LogInCallback() {
            @Override
        ...
        parseUser.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e == null) {
                    ...
                    //Finally save all the user details
                    Toast.makeText(FacebookLogin.this, getString(R.string.new_user) + FacebookLogin.this.name + getString(R.string.signed_up), Toast.LENGTH_SHORT).show();
