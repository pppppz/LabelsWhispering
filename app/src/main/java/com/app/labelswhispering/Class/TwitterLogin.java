...
import com.app.labelswhispering.viewcontroller.LoginActivity;
import com.app.labelswhispering.viewcontroller.MainActivity;
...
public class TwitterLogin extends AppCompatActivity {
    ...
    private static String TAG = TwitterLogin.class.getSimpleName();
    public Bitmap profilePic;
    String profilePicLink;
    ParseUser parseUser;
    String name, username;

    private Bitmap downloadProfileImg(String url) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ParseTwitterUtils.logIn(TwitterLogin.this, new LogInCallback() {
            ...
            public void done(ParseUser user, ParseException e) {
                if (e == null) {
                    if (user == null) {
                        Log.e(TAG, "Uh oh. The user cancelled the Twitter login.");
                        Intent intent = new Intent(TwitterLogin.this, LoginActivity.class);
                        startActivity(intent);
                        finish();
                    } else if (user.isNew()) {
                        Log.e(TAG, "User signed up and logged in through Twitter!");
                        try {
                        ...
                        Log.e(TAG, "User logged in through Twitter!");
                        Intent intent = new Intent(TwitterLogin.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                    }
                    ...
                    Log.e(TAG, "twitter " + e);
                    Toast.makeText(TwitterLogin.this, R.string.error_message_twitter, Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(TwitterLogin.this, LoginActivity.class);
                    startActivity(intent);
                    finish();
                }
        ...
        parseUser.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e == null) {
                    ...
                    Toast.makeText(TwitterLogin.this, "New user:" + TwitterLogin.this.name + " Signed up", Toast.LENGTH_SHORT).show();
                    Log.e(TAG, "Hooray! new user had created");
                } else {
                    /** Sign up didn't succeed. Look at the ParseException to figure out what went **/
                    Log.e(TAG, "didn't succeed =" + e);
                }
            }
        });
    }
            ...
            public void onResponse(Response response) {
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        Log.e(TAG, "profile pic link :" + profilePicLink);
    ...
    class ProfilePhotoAsync extends AsyncTask<String, String, Bitmap> {
        ...
        protected Bitmap doInBackground(String... params) {
            ...
            return profilePic = downloadProfileImg(ProfileLink);
        }
