...
import com.app.labelswhispering.OtherClass.Listener.RecyclerViewOnScrollListener;
import com.app.labelswhispering.OtherClass.RowInDetails;
...
public class MedicineDetails_Activity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    private final String TAG = MedicineDetails_Activity.class.getSimpleName();
    protected ParseUser parseUser;
    protected boolean hasAdded = false;
    protected List<Pictures> pictureList = new ArrayList<>();
    protected ImageView imgToolbar;
    protected Menu mMenu;
    protected LinearLayout mLinearLayoutProperty, mLinearLayoutIfForget, mLinearLayoutSideEffect, mLinearLayoutHowToKeep, mLinearLayoutHowToTake, mLinearLayoutTellDoctor, mLinearLayoutPicture;
    protected LinearLayout mLinearLayoutHeaderProperty, mLinearLayoutHeaderIfForget, mLinearLayoutHeaderSideEffect, mLinearLayoutHeaderHowToKeep, mLinearLayoutHeaderHowToTake, mLinearLayoutHeaderTellDoctor, mLinearLayoutHeaderPicture;
    protected TextView tvType;
    protected CheckBox beforeMeal, afterMeal, Morning, Noon, Evening, Bedtime;
    protected WebView webHowToTake, webHowToKeep, webIfForget, webTellDoctor, webGeneral, webBad, webProperty;
    ...
    RecyclerItemClickListener recyclerItemClickListener = new RecyclerItemClickListener(getBaseContext(), new RecyclerItemClickListener.OnItemClickListener() {
        ...
        public void onItemClick(View view, int position) {
            ...
            try {
                ...
                //Create intent
                Intent intent = new Intent(MedicineDetails_Activity.this, DisplayImg_Activity.class);
