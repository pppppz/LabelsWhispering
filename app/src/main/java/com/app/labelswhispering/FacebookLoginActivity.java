        ...
        parseUser.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e == null) {
                    ...
                    //Finally save all the user details
                    Toast.makeText(FacebookLoginActivity.this, getString(R.string.new_user) + FacebookLoginActivity.this.name + getString(R.string.signed_up), Toast.LENGTH_SHORT).show();
