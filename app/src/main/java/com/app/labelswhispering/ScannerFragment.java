...
public class ScannerFragment extends Fragment implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(Result rawResult) {
        ...
        //  Toast.makeText(fActivity, "Contents = " + rawResult.getText() + ", Format = " + rawResult.getBarcodeFormat().toString(), Toast.LENGTH_SHORT).show();
            ...
            public void done(List<Barcode> medicineName, ParseException e) {
                ...
                if (e == null) {
                    ...
                    if (medicineName.size() == 1) {
                        Intent intent = new Intent(fActivity, MedicineDetail_Activity.class);
