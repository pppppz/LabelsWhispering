...
public class TwitterLoginActivity extends AppCompatActivity {
    ...
    private static String TAG = TwitterLoginActivity.class.getSimpleName();
        ...
        ParseTwitterUtils.logIn(TwitterLoginActivity.this, new LogInCallback() {
            ...
            public void done(ParseUser user, ParseException e) {
                if (e == null) {
                    ...
                    Log.e(TAG, "twitter " + e);
                    Toast.makeText(TwitterLoginActivity.this, R.string.error_message_twitter, Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(TwitterLoginActivity.this, LoginActivity.class);
                    startActivity(intent);
                    finish();
                }
